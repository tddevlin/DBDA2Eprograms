...
fileNameRoot="Exercise-07-03" # for output filenames
...
saveGraph( file="Exercise-07-03-B" , type="png" )

# (C), (D), (E), (F) ----------------------------------------------------

# different parameters for the different parts of the question
myDataList = list(c=c(),  d=c(0,1,1), e=c(0,1,1), f=c(0,1,1))
propSDlist = list(c=0.20, d=0.20,     e=0.02,     f=0.02)
startList =  list(c=0.01, d=0.01,     e=0.01,     f=0.99)

# run the BernMetrop script for each part
for (part in c("c", "d", "e", "f")) {

  # Specify the data, to be used in the likelihood function.
  myData = myDataList[[part]]
  ...
  trajectory[1] = startList[[part]] # arbitrary value
  ...
  saveGraph( file=paste0( fileNameRoot , part ,
                         "SD" , proposalSD ,
